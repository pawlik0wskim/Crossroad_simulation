...
if __name__=='__main__':
    ...
    if mode == 'genetic algorithm':
        app.set_traffic_lights(light_cycles)
        ga = GeneticAlgorithm(number_of_iterations, simulation_length, elite_part=0.1, population_size=2, traffic_lights=light_cycles, speed_limit=speed_limit, mutation_probability=0.5, population_number=1) 
        ga.optimise(app)
