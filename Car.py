...
class Car:
    def __init__(self, position, angle = 0):
        self.img = pygame.transform.scale(pygame.image.load(r"C:\Users\Maciek\Documents\Studia\semestr 7\car_red.png").convert_alpha(),(WIDTH/60,HEIGHT/20))
